...
* Data from electoral sections for President in the city of São Paulo (2014) - .text-hl[Spatial Points];
      * Number of electors;
      * percent of votes in each candidate
* Socio demographic data from IBGE census sectros (2010) - .text-hl[Spatial Polygons];
